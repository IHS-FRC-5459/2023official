...
public class Blue42 extends SequentialCommandGroup {
  ...
  public Blue42() {
    ...
    PathPlannerTrajectory examplePath = PathPlanner.loadPath("/Paths/Blue/2ConeLevel/Spot4", new PathConstraints(3, 1));
