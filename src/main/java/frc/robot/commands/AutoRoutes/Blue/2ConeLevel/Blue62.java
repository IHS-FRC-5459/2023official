...
public class Blue62 extends SequentialCommandGroup {
  ...
  public Blue62() {
    ...
    PathPlannerTrajectory examplePath = PathPlanner.loadPath("/Paths/Blue/2ConeLevel/Spot6", new PathConstraints(3, 1));
