...
public class Spot3 extends SequentialCommandGroup {
  ...
  public Spot3() {
    ...
    PathPlannerTrajectory examplePath = PathPlanner.loadPath("/Paths/Blue/2ConeLevel/Spot3", new PathConstraints(3, 1));
