...
public class Blue22 extends SequentialCommandGroup {
  ...
  public Blue22() {
    ...
    PathPlannerTrajectory examplePath = PathPlanner.loadPath("/Paths/Blue/2ConeLevel/Spot2", new PathConstraints(3, 1));
