...
public class Blue61 extends SequentialCommandGroup {
  ...
  public Blue61() {
    ...
    PathPlannerTrajectory examplePath = PathPlanner.loadPath("/Paths/Blue/2ConeGo/Spot6", new PathConstraints(3, 1));
