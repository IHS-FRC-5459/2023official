...
public class Spot5 extends SequentialCommandGroup {
  ...
  public Spot5() {
    ...
    PathPlannerTrajectory examplePath = PathPlanner.loadPath("/Paths/Red/2ConeLevel/Spot5", new PathConstraints(3, 1));
