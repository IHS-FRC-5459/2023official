...
public class Red11 extends SequentialCommandGroup {
  ...
  public Red11() {
    ...
    PathPlannerTrajectory examplePath = PathPlanner.loadPath("/Paths/Red/2ConeGo/Spot1", new PathConstraints(3, 1));
