...
public class Red21 extends SequentialCommandGroup {
  ...
  public Red21() {
    ...
    PathPlannerTrajectory examplePath = PathPlanner.loadPath("/Paths/Red/2ConeGo/Spot2", new PathConstraints(3, 1));
