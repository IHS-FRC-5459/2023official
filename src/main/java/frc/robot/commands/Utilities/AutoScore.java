...
public class AutoScore extends SequentialCommandGroup {
  ...
  public AutoScore() {
    ...
    addCommands(
      ...
      new ParallelRaceGroup(new WaitCommand(0.2), new MoveClaw(-0.25)),
      ...
      new ParallelRaceGroup(new WaitCommand(0.2), new MoveClaw(0.4))

      //new ParallelCommandGroup(new ParallelRaceGroup(new WaitCommand(0.62), new MoveClaw(0.2)))
     // new ParallelRaceGroup(new WaitCommand(0.2), new MoveClaw(0.2))
      );
  }
}
